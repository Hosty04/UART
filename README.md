...
- Control via 16 pins on the bottom side of the board for sending data to PC, displaying received data received from PC on two seven-segment (HEX number symbol of ASCII) displays on the Nexys A7-50T board.
