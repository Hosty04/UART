...
REM
REM Generated by Vivado on Fri Mar 13 09:52:17 +0100 2026
...
echo "xvhdl --incr --relax -prj cfg_tb_display_driver_vhdl.prj"
call xvhdl  --incr --relax -prj cfg_tb_display_driver_vhdl.prj -log xvhdl.log
